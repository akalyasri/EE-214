...
HD_PWD='C:/EE 214/project3/project3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log P3_R1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source P3_R1.tcl -notrace
