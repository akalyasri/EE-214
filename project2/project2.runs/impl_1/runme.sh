...
HD_PWD='C:/EE 214/project2/project2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log P2_R1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source P2_R1.tcl -notrace
