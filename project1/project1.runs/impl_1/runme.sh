...
HD_PWD='C:/EE 214/project1/project1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log P1_R5.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source P1_R5.tcl -notrace
