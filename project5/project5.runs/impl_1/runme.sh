...
HD_PWD='C:/EE 214/project5/project5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log P5_R1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source P5_R1.tcl -notrace
